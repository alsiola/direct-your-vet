...
namespace DYV.Data.Migrations
{
    ...
    [Migration("20161101153754_deli-rec-id")]
    partial class delirecid
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DYV.Models.ClientRelations.SMSSendResult", b =>
                {
                    ...
                    b.Property<int>("SMSGroupSendResultId");
                    ...
                    b.HasIndex("SMSGroupSendResultId");

                    b.ToTable("SMSSendResults");
                });
            ...
            modelBuilder.Entity("DYV.Models.ClientRelations.SMSSendResult", b =>
                {
                    b.HasOne("DYV.Models.ClientRelations.SMSGroupSendResult", "SMSGroupSendResult")
                        .WithMany("SMSSendResults")
                        .HasForeignKey("SMSGroupSendResultId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
