...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    ...
    return {
        notyMessage: function notyMessage(msg) {
            noty({
                text: msg,
                layout: 'center',
                type: 'information',
        ...
        notyConfirm: function showConfirm(msg) {
            var dfd = $.Deferred();
            var n = noty({
                text: msg,
                type: 'confirm',
                ...
                modal: true,
                buttons: [{
                    addClass: 'btn btn-primary', text: 'Ok', onClick: function onClick($noty) {
                        $noty.close();
                        dfd.resolve(true);
                    }
                }, {
                    addClass: 'btn btn-danger', text: 'Cancel', onClick: function onClick($noty) {
                        $noty.close();
                        dfd.resolve(false);
                    }
                }]
